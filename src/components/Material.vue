    ...
    export default {
        ...
        methods: {
            listar(){
                ...
                axios.get('material/list',configuracion).then(function (response){
            ...
            guardar(){
                ...
                if (this.editedIndex >-1){
                    //Código para editar
                    axios.put('material/update',{'_id':this._id,'nombre':this.nombre,'descripcion':this.descripcion},configuracion)
                    ...
                    //Código para guardar
                    axios.post('material/add',{'nombre':this.nombre,'descripcion':this.descripcion},configuracion)
                    .then(function(response){
                        me.limpiar();
                        me.close();
                        me.listar();
            ...
            activar(){
                ...
                let header={"Token" : this.$store.state.token};
                let configuracion= {headers : header};
                axios.put('material/activate',{'_id':this.adId},configuracion)
                    .then(function(response){
                        me.adModal=0;
                        me.adAccion=0;
                        me.adNombre='';
            ...
            desactivar(){
                ...
                let header={"Token" : this.$store.state.token};
                let configuracion= {headers : header};
                axios.put('material/deactivate',{'_id':this.adId},configuracion)
                    .then(function(response){
                        me.adModal=0;
                        me.adAccion=0;
                        me.adNombre='';
