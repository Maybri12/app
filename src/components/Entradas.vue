            ...
            <v-container grid-list-sm class="white">
                <v-layout row wrap>
                    ...
                    <v-flex xs12 sm2 md2 lg2 x2>
                        <v-btn color="success" @click="buscarCodigo()">Cargar compras</v-btn>
                                ...
                                <table id="facarticulo">
                                    ...
                                    <tbody>
                                        <tr v-for="det in detalles" :key="det._id">
                                            ...
                                            <td style="text-align:center;">{{ (det.cantidad * det.precio)}}
                                            </td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
...
export default {
    ...
    methods: {
        buscarCodigo() {
            ...
            axios.get('ingreso/reporte?start=' + this.date + '&end=' + this.date2, configuracion).then(function (response) {
